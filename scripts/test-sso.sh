...
#   CHAT_HOST                default chat.lab.gooptimal.io
#   GATEWAY_HOST             default gateway.lab.gooptimal.io
...
CHAT_HOST="${CHAT_HOST:-chat.lab.gooptimal.io}"
GATEWAY_HOST="${GATEWAY_HOST:-gateway.lab.gooptimal.io}"
